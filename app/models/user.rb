...
# エラーメッセージ
  ERROR_MESSAGE_EMAIL = "is invalid. Please input email correctly."   # （メールアドレスを正しく入力してください）"
  ERROR_MESSAGE_PASSWORD = "is invalid. Please input half-width characters."    # （パスワードは、半角英数字で入力してください）"
  ERROR_MESSAGE_NAME = "is invalid. Please input full-width characters."    # （お名前は、全角で入力してください）"
  ERROR_MESSAGE_NAME_READING = "is invalid. Please input full-width katakana characters."   # （お名前カナは、全角カナで入力してください）"
